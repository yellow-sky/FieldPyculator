# Based on EricPierce code from http://diotavelli.net/PyQtWiki/Python%20syntax%20highlighting
...
STYLES = {
    'numbers': generate_format('brown'),
    'keyword': generate_format('blue'),
    'defclass': generate_format('black', 'bold'),
    'string': generate_format('green'),
    ...
    #'operator': generate_format('red'),
    #'brace': generate_format('darkGray'),
}
...
class PythonHighlighter (QSyntaxHighlighter):
    ...
    def highlightBlock(self, text):
        ...
        for expression, nth, block_format in self.rules:
